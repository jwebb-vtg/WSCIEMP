...
namespace WSCIEMP.Reports.MReports {
    ...
    public partial class FieldSummary : Common.BasePage {
        ...
        private const string MOD_NAME = "Reports.MReports.FieldSummary.";
        ...
        protected void Page_Load(object sender, EventArgs e) {
            ...
            try {
                ...
                if (!Page.IsPostBack) {
                    ...
                    _factoryList = nv[lstFsFactory.ClientID.Replace("_", "$")];
                    _stationList = nv[lstFsStation.ClientID.Replace("_", "$")];
                    _contractList = nv[lstFsContract.ClientID.Replace("_", "$")];
        ...
        private void DoPrintReady(object sender, CommandEventArgs e) {
            ...
            try {
                ...
                string pdf = WSCReports.rptFieldSummary.ReportPackager(Convert.ToInt32(cropYear), _factoryList, _stationList, _contractList,
                    txtFsSHID.Text, txtFsFromSHID.Text, txtFsToSHID.Text, auth.UserID, fileName, logoUrl, pdfTempFolder);
        ...
        protected void lstFsFactory_SelectedIndexChanged(object sender, EventArgs e) {

            const string METHOD_NAME = "lstFsFactory_SelectedIndexChanged";
        ...
        protected void lstFsStation_SelectedIndexChanged(object sender, EventArgs e) {

            const string METHOD_NAME = "lstFsStation_SelectedIndexChanged";
