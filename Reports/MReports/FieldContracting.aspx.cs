...
namespace WSCIEMP.Reports.MReports {
    ...
    public partial class FieldContracting : Common.BasePage {

        private const string MOD_NAME = "Reports.MReports.FieldContracting.";
        ...
        protected void Page_Load(object sender, EventArgs e) {
            ...
            try {
                ...
                if (!Page.IsPostBack) {
                    ...
                    _factoryList = nv[lstFcFactory.ClientID.Replace("_", "$")];
                    _stationList = nv[lstFcStation.ClientID.Replace("_", "$")];
                    _contractList = nv[lstFcContract.ClientID.Replace("_", "$")];
        ...
        private void DoPrintReady(object sender, CommandEventArgs e) {
            ...
            try {
                ...
                string pdf = WSCReports.rptFieldContracting.ReportPackager(Convert.ToInt32(cropYear), _factoryList, _stationList,
                _contractList, "", auth.UserID, fileName, logoUrl, pdfTempFolder);
        ...
        protected void lstFcFactory_SelectedIndexChanged(object sender, EventArgs e) {

            const string METHOD_NAME = "lstFcFactory_SelectedIndexChanged";
        ...
        protected void lstFcStation_SelectedIndexChanged(object sender, EventArgs e) {

            const string METHOD_NAME = "lstFcStation_SelectedIndexChanged";
