<%@Page Language="C#" MasterPageFile="~/PrimaryTemplate.Master" StylesheetTheme="ThemeA_1024"
    AutoEventWireup="true" CodeBehind="AdminMain.aspx.cs" Inherits="WSCIEMP.Admin.AdminMain" Title="Western Sugar Cooperative - Agricultural Administrator Services" %>

<asp:Content ID="Content1" ContentPlaceHolderID="PageTitleHolder" runat="server">
    Agricultural Administrator Services
</asp:Content>
