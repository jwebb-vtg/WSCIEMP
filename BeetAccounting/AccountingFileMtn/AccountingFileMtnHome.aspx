<%@ Page Title="Western Sugar Cooperative - Accounting File Maintenance" Language="C#" MasterPageFile="~/PrimaryTemplate.Master" StylesheetTheme="ThemeA_1024" AutoEventWireup="true" 
CodeBehind="AccountingFileMtnHome.aspx.cs" Inherits="WSCIEMP.BeetAccounting.AccountingFileMtn.AccountingFileMtnHome" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PageTitleHolder" runat="server">
    Beet Accounting - Accounting File Maintenance
</asp:Content>
