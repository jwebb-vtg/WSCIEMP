<%@ Page Language="C#" MasterPageFile="~/PrimaryTemplate.Master" StylesheetTheme="ThemeA_1024" AutoEventWireup="true" CodeBehind="FieldHome.aspx.cs" Inherits="WSCIEMP.Fields.FieldHome" Title="Western Sugar Cooperative - Field Information" %>
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="98%">
        ...
        <tr>
            <td colspan="2" style="width: 22%; background-color:#ffffff; border-left: #FFFFFF 4px solid; border-right: #FFFFFF 4px solid; border-bottom: 2px solid #B0B0B0;">
                <asp:Menu ID="mnuLocal" runat="server" SkinID="bodyMenu" CssClass="headerMenuLinkLocal"                     
                    StaticMenuItemStyle-CssClass="mnuTopStaticMenuItemStyleLocal" StaticHoverStyle-CssClass="mnuTopStaticHoverStyleLocal"
                    StaticSelectedStyle-CssClass="mnuTopStaticSelectedStyle" DataSourceID="smdUpRoot"                                                              
