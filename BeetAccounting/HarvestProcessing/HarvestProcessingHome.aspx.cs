...
namespace WSCIEMP.BeetAccounting.HarvestProcessing {

    public partial class HarvestProcessingHome : Common.BasePage {

        private const string MOD_NAME = "BeetAccounting.HarvestProcessingHome.";
