<%@ Page Language="C#" MasterPageFile="~/PrimaryTemplate.Master" StylesheetTheme="ThemeA_1024" AutoEventWireup="true" CodeBehind="RehaulEntry.aspx.cs" Inherits="WSCIEMP.SHS.Rehaul.RehaulEntry" Title="Shrink Data Entry" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PageTitleHolder" runat="server">
    Shrink Data Entry</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentCenter" runat="server">
    ...
    function SetDateSubmit(newDate, ctl) {
        ...
        <table id="hdrStuff" style="width: 99%; background-color:White;" border="0">
            <tr>                
                ...
                <td style="text-align:right; padding-right:5px; vertical-align:top;">
                    <asp:Button ID="btnSave" runat="server" Text="Save" OnClick="btnSave_Click" CssClass="ctlWidth60" />
                </td>
            </tr>
        </table>
        <br />
                            ...
                            <table border="0" style="width: 100%; vertical-align:top;">
                                <tr style="line-height: 24px;">
                                    ...
                                    <td style="width: 25%;" class="ButtonText">
                                        <asp:TextBox ID="txtRehaulAvgWt" runat="server" CssClass="ctlWidth60" style="text-align:right; padding-right:3px;"></asp:TextBox>  
                                    </td>
                                </tr>
                                <tr style="line-height: 24px;">
                                    <td class="LabelText">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtYardAvgWt" runat="server" CssClass="ctlWidth60" style="text-align:right; padding-right:3px;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr style="line-height: 24px;">
                                    <td class="LabelText">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtChipsDiscarded" runat="server" CssClass="ctlWidth60" style="text-align:right; padding-right:3px;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr style="line-height: 24px;">
                                    <td class="LabelText">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtChipsPctTailings" runat="server" CssClass="ctlWidth60" style="text-align:right; padding-right:3px;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr style="line-height: 24px;">
                                    <td class="LabelText">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtBeetsSlidLoads" runat="server" CssClass="ctlWidth60" style="text-align:right; padding-right:3px;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr style="line-height: 24px;">
                                    <td class="LabelText">
                            ...
                            <asp:Repeater ID="rptrStations" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="ButtonText">
                                            <asp:TextBox ID="txtRehaulLoads" CssClass="ctlWidth60" runat="server" style="text-align:right; padding-right:3px;" Text='<%# Eval("RehaulLoads") %>'></asp:TextBox>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
