<%@ Page Title="Western Sugar Cooperative - Shareholder Services" Language="C#" MasterPageFile="~/PrimaryTemplate.Master" StylesheetTheme="ThemeA_1024" AutoEventWireup="true" CodeBehind="ShareholderServicesHome.aspx.cs" Inherits="WSCIEMP.BeetAccounting.ShareholderServices.ShareholderServicesHome" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PageTitleHolder" runat="server">
    Beet Accounting: Shareholder Services
</asp:Content>
